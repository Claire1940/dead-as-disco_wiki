...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Dead as Disco Wiki",
    description: "Read the Terms of Service for Dead as Disco Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Dead as Disco Wiki",
      description: "Terms and conditions for using Dead as Disco Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Dead as Disco Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Dead as Disco Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Dead as Disco Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Dead as Disco Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
            ...
            <p>
              <strong>Important:</strong> Dead as Disco Wiki is NOT affiliated with, endorsed by, or associated with
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Dead as Disco Wiki and are protected by international
            ...
            <p>
              ...
              you and Dead as Disco Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@dead-as-disco.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@dead-as-disco.wiki</a>
            </p>
            <p>
