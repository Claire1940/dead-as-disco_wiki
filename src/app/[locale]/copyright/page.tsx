...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Dead as Disco Wiki',
    description: 'Copyright and intellectual property information for Dead as Disco Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Dead as Disco Wiki',
      description: 'Copyright and intellectual property information for Dead as Disco Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Dead as Disco Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Dead as Disco Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Dead as Disco Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
            ...
            <ul>
              ...
              <li><strong>Dead as Disco Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Dead as Disco Wiki.
            </p>
            ...
            <p>
              ...
              Dead as Disco Wiki<br />
              Email: <a href="mailto:dmca@dead-as-disco.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@dead-as-disco.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Dead as Disco Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Dead as Disco Wiki (dead-as-disco.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@dead-as-disco.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@dead-as-disco.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@dead-as-disco.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@dead-as-disco.wiki</a>
            </p>
            <p>
