...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Dead as Disco Wiki',
    description: 'Dead as Disco Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Steam game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Dead as Disco Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Dead as Disco Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@dead-as-disco.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@dead-as-disco.wiki</a>
            </p>
            <p>
